...
class CommentWalker extends \Walker_Comment {
	 ...
	 */
    /* Début d'un nouveau niveau de commentaire à partir du 2eme niveau*/
	 ...
	 * @param string     $output            Used to append additional content. Passed by reference.
	 */
    /* Afficher un élément en particulier, pas besoin go delete car on héritera de la fonction parente*/
